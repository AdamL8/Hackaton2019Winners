$(document).ready(function() {
  ...
  document.body.innerHTML +=
        '<div style="position:fixed;width:50px;height:50px;opacity:0.3;z-index:100000;top:75px;right:20px;border-radius:50%;background:#000;cursor:pointer;" onClick="document.dispatchEvent(new CustomEvent(\'new_id\'));"> <img src="https://developer.android.com/images/brand/Android_Robot.png" style="width: 21px;height: 25px;margin: 50%;transform: translate(-50%, -50%);"></img></div>';
  ...
  document.addEventListener("new_id", function(e) {
    ...
    alert(lang=="fr" ? "Envoyer vers votre téléphone" : "Sent to mobile");
  });
